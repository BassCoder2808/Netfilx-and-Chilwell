"""
Functions used by the PepAi API
"""
from flask import jsonify
from sqlalchemy.orm import scoped_session

from pepai.framework.optimization_transfers import (
    make_optimum_double_transfer,
    make_optimum_single_transfer,
)
from pepai.framework.schema import Player, SessionBudget, SessionSquad, session
from pepai.framework.squad import Squad
